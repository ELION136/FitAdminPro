                ...
                <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                    ...
                    <span class="d-flex align-items-center gap-2">
                        <img class="rounded header-profile-user"
                            src="{{ url('dist/assets/images/users/avatar-1.jpg') }}" alt="Header Avatar">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarUsuarios" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="sidebarUsuarios">
                        ...
                        <!-- Entrenadores -->
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarEntrenadores" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="sidebarEntrenadores">
                                <i class="ri-run-line"></i><span data-key="t-entrenadores">Entrenadores</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarEntrenadores">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('admin.entrenadores.create') }}" class="nav-link"
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme01">
                                    <img src="{{ url('dist/assets/images/demo/default.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme02">
                                    <img src="{{ url('dist/assets/images/demo/saas.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme03">
                                    <img src="{{ url('dist/assets/images/demo/corporate.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme04">
                                    <img src="{{ url('dist/assets/images/demo/galaxy.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme05">
                                    <img src="{{ url('dist/assets/images/demo/material.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme06">
                                    <img src="{{ url('dist/assets/images/demo/creative.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme07">
                                    <img src="{{ url('dist/assets/images/demo/minimal.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme08">
                                    <img src="{{ url('dist/assets/images/demo/modern.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme09">
                                    <img src="{{ url('dist/assets/images/demo/interactive.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme10">
                                    <img src="{{ url('dist/assets/images/demo/classic.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio">
                                ...
                                <label class="form-check-label p-0" for="customizer-theme11">
                                    <img src="{{ url('dist/assets/images/demo/vintage.png') }}" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="{{ url('dist/assets/images/sidebar/img-1.jpg') }}" alt=""
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="{{ url('dist/assets/images/sidebar/img-2.jpg') }}" alt=""
                                        class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="{{ url('dist/assets/images/sidebar/img-3.jpg') }}" alt=""
                                        class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="{{ url('dist/assets/images/sidebar/img-4.jpg') }}" alt=""
                                        class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                        </div>
