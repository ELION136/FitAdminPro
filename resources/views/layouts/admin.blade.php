                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="index.html" class="header-logo">
                                <img src="{{ url('assets/images/brand-logos/2desktop-logo-white.png') }}"
                                    alt="logo" class="desktop-logo">
                                <img src="{{ url('assets/images/brand-logos/toggle-logo2-white.png') }}"
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu"
                            ...
                            @if (auth()->user()->rol === 'Administrador')
                                <li><a class="dropdown-item d-flex" href="{{ route('profile.index') }}"><i
                                            class="bx bx-cog fs-18 me-2 op-7"></i>
                                        </i>Perfil</a>
                                </li>
                            @elseif (auth()->user()->rol === 'Entrenador')
                            ...
                            @elseif (auth()->user()->rol === 'Cliente')
                                <li><a class="dropdown-item d-flex" href="{{ route('admin.clientes.profile') }}"><i
                                            class="bx bx-cog fs-18 me-2 op-7"></i>
                                        Perfil</a></li>
                            @endif
                        ...
                        @if (auth()->user()->rol === 'Cliente')
                            ...
                            <li class="slide has-sub">
                                <a href="javascript:void(0);" class="side-menu__item">
                                    ...
                                    <span class="side-menu__label">Mis Membresias</span>
                                    <i class="fe fe-chevron-right side-menu__angle"></i>
                                </a>
                                <ul class="slide-menu child1">
                                    <li class="slide side-menu__label1">
                                        <a href="javascript:void(0);">Mis Membresias</a>
                                    </li>
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    <li class="slide side-menu__label1">
                                        <a href="javascript:void(0);">Mis Servicios</a>
                                    </li>
                                    <li class="slide">
                                        <a href="grid-tables.html" class="side-menu__item">Reservas</a>
                                    </li>
                                    <li class="slide">
                                        <a href="data-tables.html" class="side-menu__item">detalles</a>
                                    </li>
                                </ul>
                            </li>
