                    ...
                    <div class="main-profile-overview">
                        ...
                        <div class="d-flex justify-content-between mb-4">
                            <div>
                                ...
                                <p class="main-profile-name-text">{{ $entrenador->especialidad ?? 'No profession available' }}</p>
                            </div>
                        </div>
                        <h6 class="fs-14">Biografia</h6>
                        <div class="main-profile-bio">
                            {{ $entrenador->descripcion ?? 'No description available' }}<a href="javascript:void(0);">More</a>
                        </div>
                        <hr class="border-1">
                        <h6 class="fs-14">Nombre completo</h6>
                        <div>                      
                            <p class="main-profile-name-text">
                                {{ $entrenador->nombre ?? 'No name available' }} {{ $entrenador->primerApellido ?? '' }} {{ $entrenador->segundoApellido ?? '' }}
                            </p>
                        </div>
                        <hr class="border-0">
                        ...
                        <div>                      
                            <p class="main-profile-name-text">
                                {{ $entrenador->fechaNacimiento ? $entrenador->fechaNacimiento->format('d/m/Y') : 'No birth date available' }} 
                                ({{ $entrenador->fechaNacimiento ? \Carbon\Carbon::parse($entrenador->fechaNacimiento)->age : 'N/A' }} años)
                            </p>
                        </div>
                        <hr class="border-0">
                        ...
                        <div>                      
                            <p class="main-profile-name-text">
                                {{ $entrenador->fechaContratacion ? $entrenador->fechaContratacion->format('d/m/Y') : 'No hiring date available' }}
                            </p>
                        </div>
                        <hr class="border-1">
                        ...
                        <div>                      
                            <p class="main-profile-name-text">
                                {{ $entrenador->direccion ?? 'No definida' }}
                            </p>
                        </div>
                        <!--skill bar-->
                    </div>
    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3 needs-validation" novalidate action="{{ route('admin.entrenadores.updateProfile') }}" method="POST" enctype="multipart/form-data" id="updateProfileForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="nombre" value="{{ old('nombre', $entrenador->nombre) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="primerApellido" value="{{ old('primerApellido', $entrenador->primerApellido) }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="segundoApellido" value="{{ old('segundoApellido', $entrenador->segundoApellido) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="direccion" value="{{ old('direccion', $entrenador->direccion) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control @error('fechaContratacion') is-invalid @enderror" id="fechaContratacion" name="fechaContratacion" value="{{ old('fechaContratacion', \Carbon\Carbon::parse($entrenador->fechaContratacion)->format('Y-m-d')) }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="date" class="form-control @error('fechaNacimiento') is-invalid @enderror" id="fechaNacimiento" name="fechaNacimiento" value="{{ old('fechaNacimiento', \Carbon\Carbon::parse($entrenador->fechaNacimiento)->format('Y-m-d')) }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="descripcion" rows="2">{{ old('descripcion', $entrenador->descripcion) }}</textarea>
                            </div>
                        </div>
                    </div>
