...
<body>
    <div class="header">
        <img src="{{ url('assets/images/brand-logos/toggle-logo2.png') }}" alt="Logo" class="logo">
        <h1 class="report-title">Reporte de Entrenadores</h1>
    </div>

    <div class="meta-info">
        Fecha de generación: {{ now()->format('d/m/Y H:i:s') }}<br>
        Total de entrenadores: {{ $entrenadores->count() }}
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $entrenador->fechaContratacion->format('d/m/Y') }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
