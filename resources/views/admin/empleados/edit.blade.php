        ...
        <div class="my-auto">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.empleados.index') }}">Entrenador</a></li>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.empleados.update', $empleado->idEmpleado) }}" method="POST"
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control @error('primerApellido') is-invalid @enderror"
                                    ...
                                    value="{{ old('primerApellido', $empleado->primerApellido) }}" required>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="date" class="form-control @error('fechaNacimiento') is-invalid @enderror"
                                    ...
                                    value="{{ old('fechaNacimiento', \Carbon\Carbon::parse($empleado->fechaNacimiento)->format('Y-m-d')) }}"
                                    required>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <select class="form-control @error('genero') is-invalid @enderror" id="genero"
                                    ...
                                    <option value="Masculino"
                                        {{ old('genero', $empleado->genero) == 'Masculino' ? 'selected' : '' }}>Masculino
                                    </option>
                                    <option value="Femenino"
                                        {{ old('genero', $empleado->genero) == 'Femenino' ? 'selected' : '' }}>Femenino
                                    </option>
                                </select>
                                @error('genero')
                                    <small style="color:red">{{ $message }}</small>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input type="date" class="form-control @error('fechaContratacion') is-invalid @enderror"
                                    ...
                                    value="{{ old('fechaContratacion', \Carbon\Carbon::parse($empleado->fechaContratacion)->format('Y-m-d')) }}"
                                    required>
