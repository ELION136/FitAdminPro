...
<body>
    <div class="header">
        ...
        <div>
            ...
            <p class="meta-info">
                ...
                Total de Inscripciones: {{ $totalInscripciones }}<br>
                Total de Pagos Completados: {{ number_format($totalPagos, 2, ',', '.') }} Bs.<br>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($inscripcion->fechaInicio)->format('d/m/Y') }}</td>
                <td>{{ \Carbon\Carbon::parse($inscripcion->fechaFin)->format('d/m/Y') }}</td>
    ...
    <div class="totales">
        <strong>Total de Inscripciones: </strong> {{ $totalInscripciones }} <br>
        <strong>Total de Pagos Completados: </strong> {{ number_format($totalPagos, 2, ',', '.') }} Bs.
    </div>
