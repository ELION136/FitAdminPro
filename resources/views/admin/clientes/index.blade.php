    ...
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
        <div class="card">
            <div class="card-header pb-0">
                ...
                <a href="{{route('admin.clientes.create')}}" class="btn btn-info rounded-pill btn-wave" data-bs-original-title="Añadir">
                            ...
                            <tr>
                                <td>
                                    @if($cliente->usuario->image)
                                        <img src="{{ asset('storage/' . $cliente->usuario->image) }}" alt="Foto de perfil" width="50" height="50">
                                    @else
                                ...
                                <td>
                                    <a href="{{route('admin.clientes.edit', $cliente->idCliente)}}"  class="btn btn-sm btn-info btn-b" data-bs-toggle="tooltip" title="" data-bs-original-title="Editar">
                                        <i class="bi bi-pen-fill"></i>
                                    </a>
                                    <form action="{{ route('admin.clientes.destroy', $cliente->idCliente) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
