                    ...
                    <div class="main-profile-overview">
                        ...
                        <div>                      
                            <p class="main-profile-name-text">
                                {{ $cliente->nombre ?? 'No name available' }} {{ $cliente->primerApellido ?? '' }} {{ $cliente->segundoApellido ?? '' }}
                            </p>
                        </div>
                        <hr class="border-0">
                        ...
                        <div>                      
                            <p class="main-profile-name-text">
                                {{ $cliente->fechaNacimiento ? $cliente->fechaNacimiento->format('d/m/Y') : 'No birth date available' }} 
                                ({{ $cliente->fechaNacimiento ? \Carbon\Carbon::parse($cliente->fechaNacimiento)->age : 'N/A' }} años)
                            </p>
                        </div>
    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3 needs-validation" novalidate action="{{ route('admin.clientes.updateProfile') }}" method="POST" enctype="multipart/form-data" id="updateProfileForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="primerApellido" value="{{ old('primerApellido', $cliente->primerApellido) }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="segundoApellido" value="{{ old('segundoApellido', $cliente->segundoApellido) }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="form-label">Correo Electronico <span style="color:red">*</span></i></label>
                            </div>
                            <div class="col-md-9">
