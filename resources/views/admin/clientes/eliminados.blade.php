...
@section('content')
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div class="my-auto">
            <h5 class="page-title fs-21 mb-1">Lista de clientes Eliminados</h5>
            <nav>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.clientes.index') }}" class="btn btn-info rounded-pill btn-wave" data-bs-original-title="Añadir">
                                ...
                                <tbody>
                                    @foreach ($eliminados as $cliente)
                                        <tr>
                                            ...
                                            <td>
                                                <form
                                                    action="{{ route('admin.clientes.restore', $cliente->idCliente) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PATCH')
